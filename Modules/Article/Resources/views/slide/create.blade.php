...
<div class="form-group row">
    <label for="pic" class="col-12 col-sm-3 col-form-label text-md-right">内容</label>
...
<div class="form-group row">
    <label for="enable" class="col-12 col-sm-3 col-form-label text-md-right" style="padding-top:initial;">开启</label>
    <div class="col-12 col-md-9">
